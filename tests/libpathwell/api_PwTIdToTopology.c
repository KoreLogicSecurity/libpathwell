 ...
 ***********************************************************************
 *
 * $Id: api_PwTIdToTopology.c,v 1.12 2013/08/30 21:13:12 klm Exp $
 *
 ***********************************************************************
 *
...
main(int iArgumentCount, char *ppcArgumentVector[])
{
  ...
  TEST_TUPLES asTuples[] =
  {
    ...
    { "bitmask", PATHWELL_TOKEN_SET_ID_1, "", 1064, "Invalid topology ID."},
    { "bitmask", PATHWELL_TOKEN_SET_ID_1, "", 1128, "Invalid topology ID."},
    { "bitmask", PATHWELL_TOKEN_SET_ID_2, "", 1641, "Invalid topology ID."},
    { "bitmask", PATHWELL_TOKEN_SET_ID_1, "", 4256, "Invalid topology ID."},
    { "bitmask", PATHWELL_TOKEN_SET_ID_1, "", 4257, "Invalid topology ID."},
    { "bitmask", PATHWELL_TOKEN_SET_ID_2, "", 144612, "Invalid topology ID."},
  };
...
//  ok(iError == 0, "set encoding");
    iError = PwTIdToTopology(psPwTContext);
    if (iError == ER_OK)
    {
      snprintf
      (
